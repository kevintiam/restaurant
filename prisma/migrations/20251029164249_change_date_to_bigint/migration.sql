/*
  ...
  - You are about to alter the column `date` on the `Commande` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
